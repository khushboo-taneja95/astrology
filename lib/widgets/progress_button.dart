...
enum ButtonState { idle, loading, success, fail, dissable, enable }
...
class ProgressButton extends StatefulWidget {
  ...
  factory ProgressButton.icon({
    ...
    Map<ButtonState, Widget> stateWidgets = {
      ButtonState.idle:
          buildChildWithIcon(iconedButtons[ButtonState.idle]!, 0, textStyle),
      ...
      ButtonState.dissable: buildChildWithIcon(
        iconedButtons[ButtonState.dissable]!,iconPadding, textStyle),
      ButtonState.enable: buildChildWithIcon(
        iconedButtons[ButtonState.enable]!,iconPadding, textStyle)
    };
    ...
    Map<ButtonState, Color> stateColors = {
      ...
      ButtonState.dissable: iconedButtons[ButtonState.dissable]!.color,
      ButtonState.enable: iconedButtons[ButtonState.enable]!.color,
    };
